...
internal abstract class AbstractAvroEncoder : AbstractEncoder(), AvroEncoder {
    ...
    override fun encodeNull() {
        if (currentWriterSchema.isUnion) {
            trySelectTypeFromUnion(Schema.Type.NULL) || throw SerializationException("Cannot encode null value for non-nullable schema: $currentWriterSchema")
    ...
    override fun encodeBytes(value: ByteArray) {
        if (currentWriterSchema.isUnion) {
            trySelectTypeFromUnion(Schema.Type.BYTES) ||
    ...
    override fun encodeBoolean(value: Boolean) {
        if (currentWriterSchema.isUnion) {
            trySelectTypeFromUnion(Schema.Type.BOOLEAN) ||
                trySelectTypeFromUnion(Schema.Type.STRING) ||
    ...
    override fun encodeInt(value: Int) {
        if (currentWriterSchema.isUnion) {
            trySelectTypeFromUnion(Schema.Type.INT) ||
                trySelectTypeFromUnion(Schema.Type.LONG) ||
                trySelectTypeFromUnion(Schema.Type.STRING) ||
    ...
    override fun encodeFloat(value: Float) {
        if (currentWriterSchema.isUnion) {
            trySelectTypeFromUnion(Schema.Type.FLOAT) ||
                trySelectTypeFromUnion(Schema.Type.DOUBLE) ||
                trySelectTypeFromUnion(Schema.Type.STRING) ||
