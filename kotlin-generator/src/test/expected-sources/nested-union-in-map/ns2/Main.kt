...
@Serializable
@AvroGenerated("""{"type":"record","name":"Main","namespace":"ns2","fields":[{"name":"field","type":{"type":"map","values":[{"type":"record","name":"A","fields":[{"name":"field","type":"int"}]},{"type":"record","name":"B","fields":[{"name":"field","type":"int"}]}]}}]}""")
