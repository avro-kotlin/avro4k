...
internal inline fun <reified T : Any> StringSpecRootScope.basicScalarEncodeDecodeTests(value: T, expectedSchema: Schema, apacheCompatibleValue: Any? = value) {
...
internal inline fun <reified T : Any, reified R : Any> StringSpecRootScope.testSerializationTypeCompatibility(logicalValue: T, apacheCompatibleValue: R, writerSchema: Schema) {
