...
class BasicEncoderTest : WordSpec({
    ...
    "encode fields" should {
        "encode strings as UTF8" {
            ...
            val record = Avro.default.encodeToGenericData(StringFoo("hello"))
