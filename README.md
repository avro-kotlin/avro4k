...
| `kotlinx.datetime.Instant`   | `long`                                      | `string` (ISO8601)                                           | `timestamp-millis`       | Native support, no annotation required                                                                                                              |
| `kotlinx.datetime.Instant`   | `long`                                      | `string` (ISO8601)                                           | `timestamp-micros`       | Use writer schema with `timestamp-micros` logical type                                                                                              |
| `kotlinx.datetime.Instant`   | `long`                                      | `string` (ISO8601)                                           | `timestamp-nanos`        | Use writer schema with `timestamp-nanos` logical type                                                                                               |
